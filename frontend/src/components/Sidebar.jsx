        ...
        <div className="h-full flex flex-col">
          ...
          <nav className="space-y-3 flex-grow">
            ...
            <div className="group relative">
              <div className="h4 opacity-50 hover:opacity-100 transition-opacity duration-200 cursor-default mb-3">
                work
              </div>
        ...
        >
          ...
          <div className="flex-grow flex flex-col justify-between px-8 py-8 overflow-y-auto">
            ...
            <div className="pt-8 mt-8">
              <button
                onClick={handleInfoClick}
                className="block h4 opacity-50 hover:opacity-100 transition-opacity duration-200 text-left"
              >
                about
              </button>
            </div>
